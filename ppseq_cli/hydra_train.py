import os
import sys
from ppseq_cli.config import get_cfg_path
cfgDir, cfgFile = get_cfg_path()
...
from ppseq_cli.config import get_arguments, get_config,omega2yacs
...
@hydra.main(config_path=cfgDir, config_name=cfgFile)
def main(conf: DictConfig):
    # 将omegaconf转为yacs的config
    conf = omega2yacs(conf)
